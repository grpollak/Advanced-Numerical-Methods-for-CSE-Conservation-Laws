...
\begin{defnbox}\nospacing
    \begin{defn}[\hfill\proofref{proof:defn:central_schemes}\newline Central Schemes]\label{defn:central_schemes}\leavevmode\\
        ...
        \begin{align}
          ...
          &\hfill\frac{s^{r}_{\idxj+1/2}\flux \left(u_{\idxj}^{n}\right)-s^{l}_{\idxj+1/2}\flux \left(u_{\idxj+1/2}^{n}\right)+s^{r}_{\idxj+1/2}s^{l}_{\idxj+1/2}\left(u_{\idxj+1}^{n}-u_{\idxj}^{n}\right)}{s^{r}_{\idxj+1/2}-s^{l}_{\idxj+1/2}}\nonumber
        \end{align}}
